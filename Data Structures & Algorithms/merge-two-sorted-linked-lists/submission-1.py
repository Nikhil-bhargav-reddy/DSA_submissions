class Solution:
    def mergeTwoLists(self, list1: Optional[ListNode], list2: Optional[ListNode]) -> Optional[ListNode]:
        ...
        dummy = ListNode()
        tail = dummy # would help us keep looking for smaller ll and keep adding to tail.next
        ...
        while list1 and list2:
            ...
            tail = tail.next # would help us keep moving tail's position we are iterating on for comparing
