class Solution:
    def asteroidCollision(self, asteroids: List[int]) -> List[int]:
        ...
        # end time 9:13
        # it took me quite a while to figure out the edge cases, I drafted the intition while on subway, but still took almost 45 minutes and 10-15 trails to get this
