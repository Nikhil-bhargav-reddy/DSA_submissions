class Solution:
    def maxDepth(self, root: Optional[TreeNode]) -> int:
        ...
        left = maxDepth(root.left) # calls first recurison, then within recurison, then within etc
        right = maxDepth(root.right) # calls first recursion, then within recursion etc
