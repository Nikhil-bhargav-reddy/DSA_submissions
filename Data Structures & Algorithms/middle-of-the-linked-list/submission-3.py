...
class Solution:
    def middleNode(self, head: Optional[ListNode]) -> Optional[ListNode]:
        ...
        target = (length//2)+1 
        # we dont ened two checks for even and odd, because questions says us 
        # to return middle if one, of upper middle if 2 which means essentially length//2 +1 solves both cases
        # run a sample like 5 and 6 individually and check
