class Solution:
    def sortColors(self, nums: List[int]) -> None:
        ...
        # rule of thumb, in place sorting = bubble or selection for my knowledge.
        # bubble is just to keeps wapping beside eleemtns
        # selection is to select the min value and swap with I
