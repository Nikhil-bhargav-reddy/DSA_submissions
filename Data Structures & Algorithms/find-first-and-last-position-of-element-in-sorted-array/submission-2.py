class Solution:
    def searchRange(self, nums: List[int], target: int) -> List[int]:
        ...
        #             l = m + 1
        #     return temp_res
        def edge_finder(left): # use above code for understanding better. overall idea is that we do not stop after we find our required value, instead we temporariliy store and move left/right
        ...
        return [edge_finder(True), edge_finder(False)]
